  ...
  config: {
    ...
    translations: {
      tr: {
        ...
        'content-manager.containers.ListPage.label.admin_user': 'Kullanıcı',
        ...
        'content-manager.containers.ListPage.table-headers.experience': 'Tecrübe',
        ...
        'content-manager.containers.EditView.label.admin_user': 'Kullanıcı',
        ...
        'content-manager.containers.EditView.label.experience': 'Tecrübe',
